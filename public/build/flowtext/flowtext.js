...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flowtext = __webpack_require__(17);

	var _flowtext2 = _interopRequireDefault(_flowtext);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	__webpack_require__(19);

	new _flowtext2.default('content').init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Flowtext = function () {
	  function Flowtext(dom) {
	    _classCallCheck(this, Flowtext);
	  ...
	  _createClass(Flowtext, [{
	    ...
	    value: function splittext(dom) {
	      if (dom.children.length > 0) {
	        ...
	        var html = '';
	        for (var _i = 0; _i < dom.innerHTML.length; _i++) {
	          html += '<span>' + dom.innerHTML.charAt(_i) + '</span>';
	        }
	        dom.innerHTML = html;
	      }
	      return this;
	    ...
	    key: 'myradom',
	    value: function myradom(s, e) {
	      return Math.floor(Math.random() * (e - s + 1) + s);
	    }
	  }, {
	    key: 'setcss',
	    value: function setcss(dom, arg, value) {
	    ...
	    value: function trans() {
	      ...
	      var len = myspan.length;
	      for (var i = 0; i < len; i++) {
	        var mytop = this.myradom(consts.parameter.randomRStart, consts.parameter.randomTopEnd);
	        var myleft = this.myradom(consts.parameter.randomLeftStart, consts.parameter.randomLeftEnd);
	        var myr = this.myradom(consts.parameter.randomRStart, consts.parameter.randomREnd);
	        var myg = this.myradom(consts.parameter.randomGStart, consts.parameter.randomGEnd);
	        var myb = this.myradom(consts.parameter.randomBStart, consts.parameter.randomBEnd);
	        var mydeg = this.myradom(consts.parameter.randomDegStart, consts.parameter.randomDegEnd);
	        var mya = 0;
	    ...
	    value: function move() {
	      ...
	      (0, _util.nextframe)(this.move.bind(this));
	    }
	  }, {
	    key: 'stopJudege',
	    value: function stopJudege(obj, i) {
	      console.log(i);
