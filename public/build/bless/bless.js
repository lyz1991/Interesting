...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bless = __webpack_require__(11);
...
/***/ function(module, exports) {
	...
	var nextframe = exports.nextframe = function () {
	  return window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (callback) {
	    return setTimeout(callback, 1000 / 64);
	  };
	}();
	var radomcolor = exports.radomcolor = function radomcolor() {
	  return '#' + Math.floor(Math.random() * 16777);
	};
	var distance = exports.distance = function distance(x, y, x1, y1) {
	...
	var Bless = function () {
	  ...
	  _createClass(Bless, [{
	    ...
	    value: function draw() {
	      ...
	      var line = consts.ctx.createLinearGradient(0, 30, 0, 250);
	      ...
	      consts.ctx.stroke();
	      consts.ctx.beginPath();
	      var zhu = consts.ctx.createLinearGradient(232, 250, 322, 550);
	      ...
	      consts.ctx.fill();
	      consts.ctx.closePath();
	      (0, _util.nextframe)(this.draw.bind(this));
	    }
	  }, {
	    key: 'drawzhu',
	    value: function drawzhu() {
	      consts.ctx.beginPath();
	      var zhu = consts.ctx.createLinearGradient(232, 250, 322, 550);
	      zhu.addColorStop(0, consts.ztopcolor);
	      zhu.addColorStop(0.3, consts.zmidcolor);
...
/***/ function(module, exports) {
	...
	var cwidth = exports.cwidth = 600;
	var cheight = exports.cheight = 520;
	var color = exports.color = '#FDA936';
	var shadowColor = exports.shadowColor = '#FDA936';
	var shadowOffsetY = exports.shadowOffsetY = -10;
	var shadowBlur = exports.shadowBlur = 20;
	var gtopcolor = exports.gtopcolor = '#FDA936';
	var gmidcolor = exports.gmidcolor = 'white';
	var bomcolor = exports.bomcolor = '#494e85';
	var globalAlpha = exports.globalAlpha = 0.8;
	var globalCompositeOperation = exports.globalCompositeOperation = 'lighter';
	var xincolor = exports.xincolor = '#241916';
	var ztopcolor = exports.ztopcolor = '#DA1411';
	var zmidcolor = exports.zmidcolor = '#9E1513';
	var zbomcolor = exports.zbomcolor = '#720000';
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "canvas {\n  margin: 0 auto;\n  display: block;\n}\np {\n  width: 60%;\n  margin-left: 18%;\n  text-align: center;\n  background-image: -webkit-gradient(linear, 0 0, 0 bottom, from(#ff0000), to(#ffff00));\n  -webkit-background-clip: text;\n  color: transparent;\n  margin-top: 30px;\n  font-size: 50px;\n}\na {\n  right: 20px;\n  bottom: 20px;\n}\n", ""]);
