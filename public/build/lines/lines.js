...
/***/ function(module, exports, __webpack_require__) {
	...
	var _lines = __webpack_require__(21);

	var _lines2 = _interopRequireDefault(_lines);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	new _lines2.default(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Line = function () {
	  function Line(num) {
	    ...
	    while (this.num) {
	      var vecter = { x: Math.random() * this.w, y: Math.random() * this.h, cx: Math.random() * 4 - 2, cy: Math.random() * 4 - 2 };
	      ...
	      for (var i = 0; i < arr.length; i++) {
	        ...
	        for (var j = i + 1; j < arr.length; j++) {
	          if ((arr[j].x - arr[i].x) * (arr[j].x - arr[i].x) + (arr[j].y - arr[i].y) * (arr[j].y - arr[i].y) < 1000) {
	            this.ctx.beginPath();
	            var fillstyle = this.ctx.createLinearGradient(arr[j].x, arr[j].y, arr[i].x, arr[i].x);
