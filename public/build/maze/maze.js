...
/***/ function(module, exports) {
	...
	var Maze = function () {
	  ...
	  _createClass(Maze, [{
	    key: 'selecwall',
	    value: function selecwall(i) {
	      var near = this.nearroom(i);
	      if (near.visit) {
	    ...
	    key: 'draw',
	    value: function draw(room) {
	      for (var i = 1; i < room.length; i++) {
	        var row = Math.ceil(i / this.num) - 1;
	        var column = i % this.num === 0 ? (i - 1) % this.num + 1 : i % this.num;
	        if (this.rooms[i].top) {
