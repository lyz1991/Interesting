...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dottext = __webpack_require__(15);

	var _dottext2 = _interopRequireDefault(_dottext);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	new _dottext2.default(['北斗']).start();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _partical = __webpack_require__(16);

	var _partical2 = _interopRequireDefault(_partical);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var dottext = function () {
	  function dottext() {
	    var arr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ['刘云钊'];

	    _classCallCheck(this, dottext);
	  ...
	  _createClass(dottext, [{
	    ...
	    value: function init() {
	      ...
	      for (var i = 0; i < this.totalnum; i++) {
	        var x = i * this.avgw % this.w;
	        var y = Math.ceil(i * this.avgw / this.w) * this.avgw;
	    ...
	    value: function createcanvas(w, h) {
	      ...
	      var data = tctx.getImageData(0, 0, 600, 600);
	      this.copy(data);
	    }
	  }, {
	    key: 'copy',
	      ...
	      for (var i = 0; i < this.h; i++) {
	        for (var j = 0; j < this.w; j++) {
	          ...
	          if (data.data[pos] != 255) {
	            this.particals.push(new _partical2.default(j, i));
	          }
	        }
	      }
...
/***/ function(module, exports) {
	...
	var partical = function partical(x, y) {
