...
/***/ function(module, exports, __webpack_require__) {
	...
	new _slider2.default(1000).init();
	  ...
	  _createClass(Slider, [{
	    ...
	    value: function bind() {
	      ...
	      this.go.click(function () {
	        ...
	        _this.container.stop().animate({ left: -_this.num * _this.oneleft + 'px' });
	      });
	      this.prev.click(function () {
	        _this.num--;
	        if (_this.num < 0) {
	          _this.container.css('left', -_this.oneleft * 11 + 'px');
	          _this.num = 10;
	        }
	        _this.container.stop().animate({ left: -_this.num * _this.oneleft + 'px' });
	      });
	      $('#go, #prev, img').hover(function () {
	        clearInterval(_this.timer);
	        _this.timer = null;
	      }, function () {
	        _this.timer = setInterval(_this.auto.bind(_this), _this.t);
	      });
	    }
	  }, {
	    key: 'auto',
