...
/***/ function(module, exports, __webpack_require__) {
	...
	var _according = __webpack_require__(37);

	var _according2 = _interopRequireDefault(_according);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	__webpack_require__(38);

	new _according2.default().init();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var According = function () {
	  function According() {
	    _classCallCheck(this, According);
	  ...
	  _createClass(According, [{
	    key: 'init',
	    value: function init() {
	      this.li.each(function (n, ele) {
	    ...
	    value: function bind() {
	      ...
	      this.doot.click(function () {
	        var idx = $(this).index('.doot');
	        var imgidx = self.len - idx - 1;
	        self.begin = idx;
	        $(this).addClass('active').siblings().removeClass('active');
	        self.go(self.li.eq(imgidx)[0], imgidx);
	      });
	      this.doot.hover(function () {
	    ...
	    value: function loop() {
	      ...
	      this.timer = setInterval(function () {
	        _this2.begin++;
	        if (_this2.begin > _this2.len - 1) {
	          _this2.begin = 0;
	        }
	        _this2.doot.eq(_this2.begin).trigger('click');
	      }, 1000);
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".lunbo-right {\n  text-align: center;\n}\n.aa {\n  position: relative;\n  padding: 0;\n  margin: 100px auto;\n  margin-bottom: 0;\n  width: 604px;\n  height: 265px;\n  overflow: hidden;\n}\n.aa li {\n  list-style: none;\n  position: absolute;\n  top: 0;\n  transition: all 400ms linear;\n}\n.doot {\n  width: 12px;\n  height: 12px;\n  display: inline-block;\n  border-radius: 50%;\n  background-color: gainsboro;\n  margin: 0 10px;\n  cursor: pointer;\n}\n.active {\n  background-color: blue;\n}\n", ""]);
