...
/***/ function(module, exports, __webpack_require__) {
	...
	var _onecol = __webpack_require__(49);

	var _onecol2 = _interopRequireDefault(_onecol);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	__webpack_require__(50);

	new _onecol2.default().init();
...
/***/ function(module, exports) {
	 ...
	 */
	var oneecol = function () {
	  function oneecol() {
	    _classCallCheck(this, oneecol);
	  ...
	  _createClass(oneecol, [{
	    ...
	    value: function bind() {
	      ...
	      document.getElementById('go').addEventListener('click', function () {
	        if (_this.mid === _this.len - 1) {
	          return false;
	        }
	        _this.mid++;
	        _this.lay(_this.mid);
	      });
	      Array.from(this.img).forEach(function (ele, i) {
	        ele.addEventListener('click', function () {
	          _this.lay(_this.mid = i);
	        });
	      });
	      return this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  background-color: black;\n  cursor: pointer;\n}\n.wap {\n  perspective: 800px;\n}\n.container {\n  position: relative;\n  width: 100%;\n  height: 450px;\n  margin: 100px auto;\n  transform-style: preserve-3d;\n  transform: perspective(800px);\n  transition: all 2s;\n}\n.container img {\n  width: 200px;\n  height: 300px;\n  position: absolute;\n  top: 0;\n  -webkit-box-reflect: below 0 -webkit-linear-gradient(transparent, transparent, rgba(255, 255, 255, 0.7));\n  transition: all 2s;\n}\np {\n  position: absolute;\n  bottom: -50px;\n  left: 46%;\n  color: red;\n  font-size: 2rem;\n}\n", ""]);
