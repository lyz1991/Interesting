...
/***/ function(module, exports, __webpack_require__) {
	...
	var _write = __webpack_require__(61);
	  ...
	  _createClass(Write, [{
	    ...
	    value: function init() {
	      consts.canvas.addEventListener('mousedown', function (e) {
	        ...
	        var beginX = e.clientX - (consts.cWith - consts.cawidth) / 2;
	      ...
	      consts.d.addEventListener('mouseup', function (e) {
	        consts.state = false;
	      });
	    }
	  }]);
...
/***/ function(module, exports) {
	...
	var i = exports.i = 0;
	var state = exports.state = true;
	var d = exports.d = document;
	var canvas = exports.canvas = d.getElementById('mycanvas');
	var ctx = exports.ctx = canvas.getContext('2d');
	var cWith = exports.cWith = d.documentElement.clientWidth;
	var color = exports.color = 'white';
	var strokewidth = exports.strokewidth = 1;
	var cawidth = exports.cawidth = canvas.width;
